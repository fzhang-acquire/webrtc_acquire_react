...
export default function AvatarIcon(props) {
  ...
  const isPopupEnabled = useSelector(state => state.isPopupEnabled);
  const width = isPopupEnabled ? '100' : '73';
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={width} height={width} style={{maxHeight: '70%',marginBottom:isPopupEnabled ?'0px':props.side?'0px':'20px'}} viewBox="0 0 73 73">
        <defs xmlns="http://www.w3.org/2000/svg">
            <linearGradient x1="9.36913521%" y1="34.587615%" x2="109.925597%" y2="72.7327956%" id="acqAvatarBG">
                <stop stopColor="#215AC6" offset="0%"/>
                <stop stopColor="#041F64" offset="100%"/>
            </linearGradient>
        </defs>
      <g fill="none" fillRule="evenodd">
        <circle cx="36.5" cy="36.5" r="36.5" fill="url(#acqAvatarBG)" />
        <path
          fill="#FFFFFF"
